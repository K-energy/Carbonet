...
contract Token is owned {
    ...
    modifier whitelisted {
        require(whitelist.isOnWhitelist(msg.sender), "sender not on whitelist");
        _;
    }

    function setWhiteListAddress(address _addr) public onlyOwner {
        whitelist = WhitelistInterface(_addr);
    }
    ...
    function mintToken(address target, uint256 mintedAmount) public whitelisted {
